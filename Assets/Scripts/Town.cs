...
public class Town : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //HealthSystem hs = hplogic.GetComponent<HealthSystem>();
        //hs.InstanceHPBAR();
    }
    public void Up_MaxHealth_Level()
    {
        if (Stats.MaxHealth_Level < Stats.Max_Level && Stats.GG_Experience >= Up_Cost)
        {
    ...
    {
        if (Stats.Damage_Level < Stats.Max_Level && Stats.GG_Experience >= Up_Cost)
        {
            Stats.GG_Experience -= Up_Cost;
    ...
    {
        if (Stats.Armor_Level < Stats.Max_Level && Stats.GG_Experience >= Up_Cost)
        {
            Stats.GG_Experience -= Up_Cost;
            Stats.Armor_Level += 1;
            Stats.GG_Armor += 1;
    ...
    {
        if (Stats.CRIT_Level < Stats.Max_Level && Stats.GG_Experience >= Up_Cost)
        {
            Stats.GG_Experience -= Up_Cost;
            Stats.CRIT_Level += 1;
            Stats.GG_CRT_CHN += 1;
    ...
    {
        if (Stats.SUP_Level < Stats.Max_Level && Stats.GG_Experience >= Up_Cost)
        {
            Stats.GG_Experience -= Up_Cost;
            Stats.SUP_Level += 1;
            Stats.GG_SUP_DMG += 1;
